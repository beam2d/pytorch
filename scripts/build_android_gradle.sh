...
export GRADLE_LOCAL_PROPERTIES=~/workspace/android/pytorch_android/local.properties
rm $GRADLE_LOCAL_PROPERTIES
echo "sdk.dir=/opt/android/sdk" >> $GRADLE_LOCAL_PROPERTIES
echo "ndk.dir=/opt/ndk" >> $GRADLE_LOCAL_PROPERTIES

sudo ${gradle_path} -DANDROID_HOME=$ANDROID_HOME -DANDROID_NDK_HOME=$ANDROID_NDK_HOME -p ~/workspace/android/pytorch_android buildRelease
